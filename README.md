...
<p align="justify">
  Lista de compras para o dia a dia.
</p>
...
:heavy_check_mark: Editar item.

:heavy_check_mark: Excluir item individualmente.

:heavy_check_mark: Excluir todos os registros da lista.
...
```
git clone https://github.com/jessicaagrs/projeto_listaDeCompras_javascript_sass.git

```

> Link para execução do projeto no browser: https://jessicaagrs.github.io/projeto_listaDeCompras_javascript_sass/
